            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex gap-2 justify-content-end">
                        <a href="{{ route('headproduction.data-pengajuan') }}" class="btn btn-light">Kembali</a>
    ...
    <div class="modal fade" id="approve" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('headproduction.approve') }}" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="rejection" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="{{ route('headproduction.reject') }}" method="POST">
                    @csrf
                    <div class="modal-body">
    ...
    <script>
        $(document).ready(function() {
            $('#approve').on('show.bs.modal', function(event) {
                ...
                modal.find('#keterangan').val('approve by head')
            })
            $('#rejection').on('show.bs.modal', function(event) {
                ...
                modal.find('#id').val(id)
                modal.find('#rejection').val('rejection by head')
            })
        })
    </script>
@endsection
